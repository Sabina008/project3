...
class Window(BaseWindow):
    """
    Provide rolling window calculator.
...
class Rolling(RollingAndExpandingMixin):
    ...
    @doc(
        ...
        dedent(
            """
        The below examples will show rolling mean calculator with window sizes of
    ...
    @doc(
        ...
        dedent(
            """
        ddof : int, default 1
            Delta Degrees of Freedom.  The divisor used in calculator
